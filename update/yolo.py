...
import numpy as np
from utils2 import load_class_names,  detect_objects, plot_boxes
...
def count_person(image, frame_no, maxpeople, i,r):
    maxpeople = maxpeople
...
#    print_objects(i, maxpeople, boxes, class_names)
    
    #Plot the image with bounding boxes and corresponding object class labels
    plot_boxes(i, frame_no, original_image, boxes, class_names,r)
