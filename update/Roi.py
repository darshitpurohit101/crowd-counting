## -*- coding: utf-8 -*-
#"""
#Created on Tue Jan 21 11:06:03 2020
#
...
class ExtractImageWidget(object):
    def __init__(self):
        self.original_image = cv2.imread('raw.jpg')
...
#        print('M: ',M)
        ...
        cv2.imwrite('rotated.jpg', self.clone)
#        cv2.imshow('defualt',self.clone)
        self.selected_ROI = False
    ...
    def crop_ROI(self):
        if self.selected_ROI:
            ...
            cv2.imwrite('cropdirect.jpg', self.cropped_image)
#            self.cropped_image = self.cropped_image[x1:y1, x2:y2]
    ...
    def show_cropped_ROI(self):
        ...
        cv2.imwrite('Output/crop1.jpg', self.cropped_image)
